...
----------------------------------------------------
-- 3. محتوى قسم الأخرى (Other) مع زر Auto Respawn الآمن
----------------------------------------------------
...
----------------------------------------------------
-- منطق الـ Auto Respawn (النسخة الآمنة والدقيقة)
----------------------------------------------------
...
task.spawn(function()
    ...
    while true do
        ...
        if autoRespawnEnabled then
            ...
            -- الضغط كل 3 ثوانٍ فقط أثناء ظهور الزر
...
----------------------------------------------------
-- المنطق والإحداثيات (كود الفارم الأصلي تماماً بدون أي تغيير)
----------------------------------------------------
local waypoints = {
