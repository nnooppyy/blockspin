...
-- الإحداثيات العامة (تم حذف النقطة الانتقالية القديمة ورقم 8 أصبح يعبر عن ممر الرفوف مباشرة)
local waypoints = {
    ...
    Vector3.new(125.54, 254.74, 201.89), -- 8 (ممر الرفوف - كان رقم 9 سابقاً)
}
...
-- دالة الحركة مع إدارة التيليبرورت بذكاء وبدون شطح
                ...
                if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
                    ...
                    if playerHasBox() then
                        ...
                        if realDeliveryPoint then
                            ...
                            -- الرجوع من ممر الرفوف (waypoints[8]) مباشرة إلى مكان الصناديق (waypoints[7]) بالترتيب العكسي
                            moveToPosition(hrp, waypoints[8], speed)
                            if not autoFarm then break end
