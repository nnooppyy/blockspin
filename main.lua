...
-- دالة إجبار الشخصية على القيام فوراً
...
-- حلقة فحص الجلوس الكثيفة (كل 0.1 ثانية) مدمجة تعمل طالما الفارم شغال
task.spawn(function()
    while true do
        task.wait(0.1)
        if autoFarm then
...
-- الربط الفوري مع حدث الجلوس للقيام المباشر دون انتظار
...
if localPlayer.Character and localPlayer.Character:FindFirstChild("Humanoid") then
    localPlayer.Character.Humanoid.Seated:Connect(function(active)
        if active and autoFarm then
            forceUnsit()
        end
    end)
