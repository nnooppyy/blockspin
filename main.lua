...
-- دالة فحص الانحناء والجلوس باستمرار لضمان عدم التعليق
...
-- الحصول على أقرب نقطة من الممرات الداخلية (1, 2, 3)
            ...
            if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
                ...
                if not playerHasBox() then
                    if isInsideGrocery(hrp.Position) then
                        ...
                        -- إذا كان بالخارج، يتبع التسلسل الطبيعي مروراً بالنقطة 6
                    ...
                    -- ضغط زر E خمس مرات متتالية لالتقاط الصندوق
                    for _ = 1, 5 do
