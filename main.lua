...
-- زر الدائرة العائم (صورة الشعار المرفق)
...
-- زر تفعيل الفرام الجديد (Switch) باسم Quick-11 📦
...
CopyLinkButton.Size = UDim2.new(0.95, 0, 0, 38)
