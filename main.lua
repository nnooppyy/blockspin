...
FloatingToggle.BackgroundColor3 = Color3.fromRGB(40, 15, 55) -- بنفسجي غامق فخم
FloatingToggle.Text = "Z"
FloatingToggle.TextColor3 = Color3.fromRGB(180, 120, 220) -- لون بنفسجي معدني فاتح
FloatingToggle.TextSize = 22
FloatingToggle.Font = Enum.Font.SourceSansBold
FloatingToggle.Draggable = true

-- إطار دائري متناسق مع حدود سوداء أنيقة
