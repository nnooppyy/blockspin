...
Title.Text = "قائمة التحكم الدقيقة"
    ...
    task.spawn(function()
        ...
        while autoFarm do
            if player.Character and player.Character:FindFirstChild("HumanoidRootPart") then
                ...
                -- 1. التأكد من الدخول والتوظف (إذا كان خارج المتجر)
                ...
                -- 2. إذا ما معه صناديق، يروح لنقطة 6 يأخذ صناديق
                ...
                if playerHasBox() then
                    ...
                    if realDeliveryPoint then
                        ...
                        -- يوقف عند الدائرة/المكان وخلاص، ينتظر شوي ثم يرجع لنقطة 7
                        task.wait(1.5)
