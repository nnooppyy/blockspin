...
local waypoints = {
    ...
    Vector3.new(146.79, 255.47, 204.95), -- 7 (مكان الصناديق الجديد)
    Vector3.new(136.50, 255.47, 203.46), -- 8 (النقطة الانتقالية)
...
-- دالة المشي المحدثة: إذا ظهر التيليبرورت تتوقف تماماً، وعندما تختفي تكمل من نفس مكانها بدقة على نفس المسار وبنفس السرعة الطبيعية
                ...
                if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
                    ...
                    if playerHasBox() then
                        ...
                        if realDeliveryPoint then
                            ...
                            -- الرجوع بنفس الطريق تماماً بالترتيب العكسي
                            moveToPosition(hrp, waypoints[9], speed)
                            if not autoFarm then break end
