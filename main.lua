...
----------------------------------------------------
-- 1. محتوى قسم الفرام (بدون خانة سرعة، السرعة مثبتة على 30)
----------------------------------------------------
...
FarmToggleContainer.MouseButton1Click:Connect(function()
    ...
    if autoFarm then
        ...
        task.spawn(function()
            -- إذا معك صناديق، يتجاوز التوظف ويبدأ فوراً. إذا ما معك، يتوظف ويرجع يشتغل.
            if not playerHasBox() then
                if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
                    local hrp = LocalPlayer.Character.HumanoidRootPart
                    local humanoid = LocalPlayer.Character:FindFirstChild("Humanoid")
                    local speed = 30 -- سرعة ثابتة على 30
