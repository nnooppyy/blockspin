...
----------------------------------------------------
-- 3. محتوى قسم الأخرى (Other) مع زر Auto Respawn الجديد
----------------------------------------------------
...
----------------------------------------------------
-- منطق الـ Auto Respawn (الانتظار الدقيق لـ 6 ثوانٍ مع التحقق من الاختفاء)
----------------------------------------------------
...
task.spawn(function()
    ...
    while true do
        ...
        if autoRespawnEnabled then
            ...
            -- إذا ظهرت الكلمة، نبدأ عداد 6 ثوانٍ ونتحقق طوال الوقت أنها لم تختفِ
            if respawnFound then
                ...
                while waitTimer < 6 and autoRespawnEnabled do
                    ...
                    -- إذا اختفت الكلمة خلال الـ 6 ثوانٍ، نلغي العملية فوراً
                ...
                -- إذا اكتملت الـ 6 ثوانٍ ولم تختفِ الكلمة، نقوم بالنقر مرة واحدة عند (400, 220)
