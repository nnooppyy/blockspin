...
----------------------------------------------------
-- منطق التنقل والحركة وإيداع الأموال (سرعة فارم 30 + إيداع فوري)
----------------------------------------------------
...
-- الضغط على زر رقم 2 في الكيبورد
...
-- =========================================================================
-- مسار الإيداع (سريع جداً في التفاعل مع الصراف)
-- =========================================================================
        ...
        task.spawn(function()
            while autoFarm do
                if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
                    ...
                    checkAndUnsit(humanoid)
                    local speed = 30 -- تم ضبط السرعة هنا إلى 30
