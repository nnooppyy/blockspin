...
local AntiSitButton = Instance.new("TextButton") -- زر منع الجلوس الجديد
...
-- زر منع الجلوس
AntiSitButton.Parent = MainFrame
AntiSitButton.Size = UDim2.new(0.9, 0, 0, 35)
AntiSitButton.BackgroundColor3 = Color3.fromRGB(50, 150, 50)
AntiSitButton.Text = "منع الجلوس: [معطل]"
AntiSitButton.TextColor3 = Color3.fromRGB(255, 255, 255)
AntiSitButton.TextSize = 14
AntiSitButton.ZIndex = 50
...
-- زر تفعيل/تعطيل منع الجلوس المستقل
AntiSitButton.MouseButton1Click:Connect(function()
    antiSitEnabled = not antiSitEnabled
    if antiSitEnabled then
        AntiSitButton.Text = "منع الجلوس: [مفعل]"
        AntiSitButton.BackgroundColor3 = Color3.fromRGB(200, 50, 50)
    else
        AntiSitButton.Text = "منع الجلوس: [معطل]"
        AntiSitButton.BackgroundColor3 = Color3.fromRGB(50, 150, 50)
    end
...
-- حلقة فحص الجلوس الدائمة
task.spawn(function()
    while true do
        task.wait(0.1)
        if antiSitEnabled or autoFarm then
