...
Title.Text = "قائمة التحكم (تعبئة كاملة)"
...
-- فحص هل اللاعب معه بضاعة/صناديق
...
-- دالة مهمة: التأكد هل الرف الحالي ما زال يطلب تعبئة ولم يكتمل بعد
    ...
    task.spawn(function()
        ...
        while autoFarm do
            if player.Character and player.Character:FindFirstChild("HumanoidRootPart") then
                ...
                -- 2. إذا ما معه صندوق، يروح لنقطة 6
                ...
                if playerHasBox() then
                    ...
                    if realDeliveryPoint then
                        ...
                        -- === التعديل الجوهري ===
                        -- الثبات عند الرف والضغط المستمر حتى يكتمل الرف تماماً وتختفي علامته أو تخلص الصناديق
                        while autoFarm and playerHasBox() and isTargetStillActive(realDeliveryPoint) do
                            pressEKey()
                            task.wait(0.2)
                        end
                        ...
                        -- أول ما يكتمل الرف 100%، يرجع لنقطة 7
                        moveToPosition(hrp, waypoints[7], speed)
                        task.wait(0.3)
                    else
                        task.wait(1)
