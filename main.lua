...
----------------------------------------------------
-- التقسيم الداخلي (القائمة الجانبية)
----------------------------------------------------
...
----------------------------------------------------
-- 🔴 نظام الفارم (الأصلي كامل بدون أي نقص) 🔴
----------------------------------------------------
local waypoints = {
...
-- لوب خلفي يضغط زر الرسبون الأحمر بمجرد ما ينتهي الوقت ويصير اسمه Respawn فقط
task.spawn(function()
    while true do
        task.wait(0.5)
        if autoRespawn then
                    ...
                    if gui:IsA("TextButton") and gui.Visible then
                        ...
                        if text == "respawn" then
                            ...
                            if absSize.X > 0 and absSize.Y > 0 then
                                ...
                                task.wait(2) -- انتظار عشان ما يكرر الضغطة بسرعة عالية
                            end
                        end
                    end
                end
