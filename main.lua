...
-- الإحداثيات العامة (مع إضافة الإحداثيات الجديدة التي طلبتها)
local waypoints = {
    ...
    Vector3.new(203.44, 254.94, 209.60), -- الجديدة 1
    Vector3.new(205.31, 254.95, 263.65)  -- الجديدة 2
}
...
-- قفل تام لاستجابة اللعبة والكاميرا والشاشة (عدا السكريبت)
local function lockGameInput(lock)
    if lock then
        ContextActionService:BindAction("BlockAllGameInputs", function() 
        ...
        ContextActionService:UnbindAction("BlockAllGameInputs")
    end
end
