...
-- زر الدائرة العائم (صورة الشعار حقك بالضبط)
...
----------------------------------------------------
-- 2. محتوى قسم الإعدادات (نقلنا زر النقاط هنا + أزرار النسخ)
----------------------------------------------------
...
-- زر الدائرة العائم يفتح ويخفي القائمة تماماً زي ما طلبت
...
FarmToggleContainer.MouseButton1Click:Connect(function()
    ...
    if autoFarm then
        ...
        task.spawn(function()
            -- إذا معك صناديق (متوظف وجاهز)، يتجاوز فحص الوظيفة ويبدأ شغل فوراً طوالي
