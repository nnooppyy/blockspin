...
local function moveToPosition(hrp, targetPos, speed)
    ...
    -- التعديل البسيط الأول: توقيف التوين إذا مات اللاعب
    ...
    repeat
        ...
        -- التعديل البسيط الثاني: إلغاء التوين إذا مات وهو يمشي
        ...
        task.spawn(function()
            while autoFarm do
                if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
                    ...
                    -- التعديل البسيط الثالث: نقلنا كود الرجوع للبقالة من برى ورميناه جوة اللوب
                    ...
                    -- نهاية التعديل اللي طلبته بالضبط
