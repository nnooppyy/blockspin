...
local function fireClosestPrompt(maxDistance)
    ...
    if closestPrompt then
        -- جرب fireproximityprompt أولاً (لو موجودة في الإكسكيوتر)
                ...
                if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
                    ...
                    if not isDepositing then
                        if not isInsideGrocery(hrp.Position) then
                            ...
                            -- اللاعب "جوا" (داخل) البقالة وشغل الفارم!
                        ...
                        if not playerHasBox() then
                            ...
                            for _ = 1, 5 do
                                ...
                                if not success then
                                    -- لو ما لقى برومبت، نضغط E كاحتياطي
                                    pressEKey()
                                end
                                task.wait(0.3)
                            end
