...
----------------------------------------------------
-- منطق الـ Auto Respawn (الضغط كل 3 ثوانٍ طالما أن الكلمة موجودة حتى تختفي)
----------------------------------------------------
...
task.spawn(function()
    ...
    while true do
        ...
        if autoRespawnEnabled then
            ...
            -- إذا وجدت الكلمة، سيقوم بالضغط كل 3 ثوانٍ حتى تختفي تماماً
            while respawnFound and autoRespawnEnabled do
                ...
                -- الانتظار لمدة 3 ثوانٍ قبل الضغطة التالية
                task.wait(3)
                
                -- إعادة التحقق مما إذا كانت الكلمة لا تزال موجودة أم اختفت
                respawnFound = false
