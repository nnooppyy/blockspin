...
----------------------------------------------------
-- دوال قراءة الكاش والتعامل مع قائمة الصراف تلقائياً
----------------------------------------------------
local VirtualInputManager = game:GetService("VirtualInputManager")
local GuiService = game:GetService("GuiService")
...
local function getPlayerCash()
    ...
    if leaderstats then
        for _, child in ipairs(leaderstats:GetChildren()) do
            ...
            if string.find(name, "cash") or string.find(name, "money") or string.find(name, "coin") then
                local rawValue = tostring(child.Value)
                local cleanNumber = string.gsub(rawValue, "%D", "")
