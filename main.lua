...
local waypoints = {
    ...
    Vector3.new(125.54, 254.74, 201.89)  -- النقطة 7 (تعبئة/تفريغ المكان)
}
...
-- وظيفة محاكاة ضغط حرف E (لأخذ الصناديق)
        ...
        if player.Character and player.Character:FindFirstChild("HumanoidRootPart") and autoFarm then
            ...
            for i = startIndex, #waypoints do
                ...
                elseif i == #waypoints then
                    -- النقطة 7 والأخيرة: النزول أسفل والتعبئة
                    task.wait(0.2)
                    ...
                    -- النقاط من 1 إلى 5: كليك ماوس عادي للتوظيف
                    task.wait(0.3)
                    clickSlightlyBelowCenter()
                end
