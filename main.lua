        ...
        while autoFarm do
            ...
            if localPlayer.Character and localPlayer.Character:FindFirstChild("HumanoidRootPart") then
                ...
                if not playerHasBox() then
                    -- 1. يبدأ من أقرب نقطة وصولاً إلى النقطة 3 بانتظام
                    ...
                    -- 2. يكمل بشكل متسلسل من 4 إلى 6
                    for i = 4, 6 do
                        if not autoFarm then break end
                        moveToPosition(hrp, waypoints[i], speed)
                    end
                    
                    -- 3. عند النقطة 6: يتحقق من حالة التوظيف (إذا لم يكن موظفاً يضغط للتوظيف)
                    if autoFarm then
                    ...
                    -- 4. ينتقل إلى النقطة 7 لأخذ الصندوق
                    if autoFarm then
                ...
                -- 5. يتأكد من مكان التوزيع ويبدأ بالتعبئة
