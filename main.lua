...
-- دالة فحص الانحناء والجلوس وإلغائهما لتجنب التعليق
local function checkAndUnsit(humanoid)
    if humanoid then
        ...
        -- فحص حالة الانحناء (إذا كان هبوط أو انحناء مفعل)
            ...
            if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
                ...
                if not playerHasBox() then
                    if isInsideGrocery(hrp.Position) then
                        -- إذا كان داخل البقالة، يتجه لأقرب نقطة داخلية (1 أو 2 أو 3 الخاصة بالداخل) بدلاً من النقطة 7 الخارجية
                        ...
                        -- إذا كان بالخارج، يتبع التسلسل الطبيعي
