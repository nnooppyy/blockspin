...
local GuiService = game:GetService("GuiService") -- تمت الإضافة عشان الرسبون
...
----------------------------------------------------
-- 🔴 إضافة الـ Auto Respawn هنا عشان ما يخرب اللي فوق 🔴
----------------------------------------------------
...
-- لوب خلفي يضغط زر الرسبون الأحمر بمجرد ما يصير متاح
task.spawn(function()
    while true do
        task.wait(0.5)
        if autoRespawn then
            ...
            if pGui then
                for _, gui in ipairs(pGui:GetDescendants()) do
                    if gui:IsA("TextButton") and gui.Visible then
                        local text = string.lower(gui.Text or "")
                        -- الشرط: إذا كان النص "respawn" بالضبط وبدون أرقام
                        if text == "respawn" then
                            ...
                            if absSize.X > 0 and absSize.Y > 0 then
                                ...
                                task.wait(2) -- انتظار عشان ما يكرر الضغطة بسرعة
                            end
                        end
                    end
                end
