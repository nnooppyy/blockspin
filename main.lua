...
-- زر الدائرة العائم (بشكل فخم واحترافي)
...
-- القائمة الرئيسية (تصميم فاخر ومرتب)
...
-- إصلاح زوايا شريط العنوان السفلية لتبقى مربعة ومتناسقة
...
Title.Text = "✨ لوحة التحكم الاحترافية"
...
ShowPointsButton.Parent = Container
...
CodeButton.Parent = Container
CodeButton.Size = UDim2.new(1, 0, 0, 40)
CodeButton.BackgroundColor3 = Color3.fromRGB(30, 100, 180)
CodeButton.Text = "📋 نسخ الإحداثيات الحالية"
CodeButton.TextColor3 = Color3.fromRGB(255, 255, 255)
CodeButton.TextSize = 13
CodeButton.Font = Enum.Font.GothamBold
CodeButton.ZIndex = 51
...
FarmButton.MouseButton1Click:Connect(function()
    ...
    if autoFarm then
        FarmButton.Text = "📦 فرام الصناديق: [مفعل]"
        FarmButton.BackgroundColor3 = Color3.fromRGB(180, 40, 40)
        
        -- نظام نبضات الشفت المعتمد
        task.spawn(function()
            while autoFarm do
                pcall(function()
...
CodeButton.MouseButton1Click:Connect(function()
    if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
        ...
        if setclipboard then
            ...
            CodeButton.Text = "✅ تم النسخ بنجاح!"
        else
            CodeButton.Text = "⚠️ النسخ غير مدعوم"
        end
        task.wait(1.5)
        CodeButton.Text = "📋 نسخ الإحداثيات الحالية"
    end
