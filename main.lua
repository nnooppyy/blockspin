...
Title.Text = "قائمة التحكم (المسار النظيف)"
...
-- النقاط الست للممرات (للمشي الآمن بدون اختراق)
local aislePoints = {
...
-- دالة إظهار أو إخفاء النقاط (بأحرف صغيرة ومرتبة)
local function toggleVisualPoints()
    ...
    if showPointsEnabled then
        ...
        local function createMarker(pos, color, text)
            ...
            part.Size = Vector3.new(1, 1, 1) -- صغرنا حجم الكرة شوي لتكون دقيقة
            ...
            bb.Size = UDim2.new(0, 60, 0, 20) -- صغرنا حجم اللوحة لتناسب النص الصغير
            ...
            txt.TextSize = 10 -- صغرنا حجم الخط وصار صغير وواضح
...
-- اختيار أقرب إحداثي من نقاط الممرات للمشي النظامي الآمن
    ...
    task.spawn(function()
        ...
        while autoFarm do
            if player.Character and player.Character:FindFirstChild("HumanoidRootPart") then
                ...
                -- 3. التوجه لنقطة 7 والرصد الصحيح عبر المسارات النظامية
