...
-- زر الدائرة العائم (شعار Zunex الصوري)
...
FloatingToggle.Image = "rbxassetid://10878171952" -- صورة الشعار الدائري المرفق
...
-- القائمة الرئيسية (رمادي داكن وشفاف)
local MainFrame = Instance.new("Frame")
MainFrame.Parent = ScreenGui
MainFrame.BackgroundColor3 = Color3.fromRGB(35, 35, 42)
MainFrame.BackgroundTransparency = 0.25 -- شفافة بلون رمادي
...
-- شريط العنوان العلوي (رمادي شفّاف)
...
Title.Text = "✨ Zunex Control Panel"
...
----------------------------------------------------
-- التقسيم الداخلي: القائمة الجانبية + محتوى
----------------------------------------------------
...
FarmButton.BackgroundColor3 = Color3.fromRGB(50, 140, 70)
...
----------------------------------------------------
-- الإحداثيات والبرمجة الداخلية (مع نظام منع التبقيص ومسكة الصندوق)
----------------------------------------------------
local waypoints = {
    ...
    Vector3.new(146.79, 255.47, 204.95), -- 7
