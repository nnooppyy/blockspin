...
-- زر الدائرة العائم (صورة افتراضية جاهزة تعمل فوراً)
...
FloatingToggle.Image = "rbxassetid://6023426915" -- صورة دائرية جاهزة وشغالة
...
-- الاسم باللغة الإنجليزية بالكامل (Zunex Store)
...
-- رابط الديسكورد في أعلى يمين القائمة
...
----------------------------------------------------
-- 1. محتوى قسم الفرام (السرعة 30 ثابتة)
----------------------------------------------------
