...
----------------------------------------------------
-- منطق التنقل والحركة وإيداع الأموال (بالإحداثيات المحددة)
----------------------------------------------------
...
-- =========================================================================
-- مسار الإيداع المطلوب: نقطة 9 -> رف S3 -> البنك (بالإحداثيات الجديدة)
-- =========================================================================
local function executeDepositSequence(speed)
    ...
    -- الضغط على الزر الأول (X: 372, Y: 162) لفتح قائمة الإيداع
    ...
    -- الضغط على الزر الثاني (X: 366, Y: 196) لتأكيد الإيداع نهائياً
