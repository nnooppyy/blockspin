...
AtmTextLabel.Text = "Bank: Loading..."
...
CashTextLabel.Text = "Cash: Loading..."
...
task.spawn(function()
    while true do
        pcall(function()
            ...
            if leaderstats then
                local cash = leaderstats:FindFirstChild("Cash") or leaderstats:FindFirstChild("Money") or leaderstats:FindFirstChild("Wallet")
                local bank = leaderstats:FindFirstChild("Bank") or leaderstats:FindFirstChild("Account")
                
                if cash then
                    CashTextLabel.Text = "Cash: " .. tostring(cash.Value)
                else
                    CashTextLabel.Text = "Cash: N/A"
                end
                
                if bank then
                    AtmTextLabel.Text = "Bank: " .. tostring(bank.Value)
                else
                    AtmTextLabel.Text = "Bank: N/A"
                end
            else
                CashTextLabel.Text = "Cash: N/A"
                AtmTextLabel.Text = "Bank: N/A"
