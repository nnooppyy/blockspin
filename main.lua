...
----------------------------------------------------
-- منطق الـ Auto Respawn (الضغط المباشر على الإحداثيات الثابتة X: 370 و Y: 156)
----------------------------------------------------
...
-- حلقة مراقبة زر الرسبون والضغط المباشر على الإحداثيات المحددة
task.spawn(function()
                    ...
                    if (descendant:IsA("TextButton") or descendant:IsA("TextLabel")) and descendant.Visible then
                        ...
                        if string.find(text, "respawn") and not string.find(text, "%d") then
                            ...
                            if targetButton and targetButton.Visible then
                                -- استخدام الإحداثيات الثابتة التي طلبتها تماماً
                                local centerX = 370
                                local centerY = 156
