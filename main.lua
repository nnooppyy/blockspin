...
-- تم تعديل الدالة لضمان المشي الطبيعي الهادئ وتوقف الـ Tween عند ظهور تحذير التيليبرورت بدون أي سرعة مفاجئة
local function moveToPosition(hrp, targetPos, speed)
    ...
    repeat
        ...
        if isTeleportDetected() then
            ...
            -- إعادة حساب الوقت المتبقي للمسافة الحالية بدقة وبدون تخطي أو سرعة زائدة
            if autoFarm then
