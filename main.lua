        ...
        task.spawn(function()
            ...
            while autoFarm do
                if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
                    ...
                    -- التحقق بعد الموت والرسباون: إذا أصبح اللاعب خارج البقالة يعيد الدخول والتسجيل
                    ...
                    -- أخذ الصندوق (الذهاب إلى نقطة 7 والتعبئة)
                    if not playerHasBox() then
                    ...
                    -- توصيل الصندوق (الذهاب إلى نقطة 8 ثم البحث عن هدف التوصيل)
