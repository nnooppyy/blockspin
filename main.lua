...
----------------------------------------------------
-- 2. محتوى قسم الإعدادات (مع تفعيل الأزرار وزر النسخ الجديد)
----------------------------------------------------
...
-- تفعيل وظائف أزرار الإعدادات التي طلبت تشغيلها
        ...
        for _, gui in ipairs(PlayerGui:GetDescendants()) do
            if (gui:IsA("TextLabel") or gui:IsA("TextButton")) and gui.Visible then
                ...
                if string.find(text, "apply") then
                    -- غير متوظف -> يحتاج توظيف
                    -- يمكنك إضافة الكود المطلوب هنا عند الحاجة للتوظيف
