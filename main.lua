...
----------------------------------------------------
-- منطق الـ Auto Respawn (الانتظار لمدة 9 ثوانٍ بدقة مع التحقق من الاختفاء)
----------------------------------------------------
...
task.spawn(function()
    ...
    while true do
        ...
        if autoRespawnEnabled then
            ...
            -- إذا ظهرت الكلمة، نبدأ عداد 9 ثوانٍ ونتحقق طوال الفترة أنها لم تختفِ
            if respawnFound then
                ...
                while waitTimer < 9 and autoRespawnEnabled do
                    ...
                    -- إذا اختفت الكلمة خلال الـ 9 ثوانٍ، نلغي العملية فوراً
                ...
                -- إذا اكتملت الـ 9 ثوانٍ ولم تختفِ الكلمة، نقوم بالنقر مرة واحدة عند (400, 220)
                if not aborted and autoRespawnEnabled then
                    ...
                    -- انتظار اختفاء القائمة تماماً لعدم التكرار
