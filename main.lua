...
-- 1. زر "فرام صناديق" (حركة ناعمة وتلقائية بدون تعليق)
        ...
        while autoFarm do
            ...
            if player.Character and player.Character:FindFirstChild("HumanoidRootPart") then
                ...
                for _, point in ipairs(waypoints) do
                    ...
                    -- حساب المسافة وتحديد السرعة المناسبة للحركة
                    local distance = (hrp.Position - point).Magnitude
                    local tweenTime = distance / 25 -- زيادة أو تقليل هذا الرقم لسرعة الحركة
                    ...
                    task.wait(0.5) -- التوقف لمدة نصف ثانية بعد كل مرحلة
                end
            else
                task.wait(0.5)
            end
