...
local waypoints = {
    Vector3.new(61.82, 254.96, 56.74),   -- النقطة 1 (مشي فقط)
    ...
    Vector3.new(164.69, 254.99, 202.29), -- النقطة 5 (التوظف - كليك ماوس)
    Vector3.new(148.91, 254.74, 208.63), -- النقطة 6 (أخذ الصناديق - ضغط E)
    Vector3.new(125.54, 254.74, 201.89)  -- النقطة 7 (الذهاب لمكان التعبئة - مشي فقط)
}
...
FarmButton.MouseButton1Click:Connect(function()
    ...
    task.spawn(function()
        ...
        if player.Character and player.Character:FindFirstChild("HumanoidRootPart") and autoFarm then
            ...
            -- الانتقال عبر النقاط مباشرة إلى الهدف
            for i = startIndex, #waypoints do
                ...
                elseif i == 6 then
                    ...
                    -- النقاط (1 إلى 4) والنقطة 7 (مكان التعبئة): مشي مباشر بدون أي أوامر إضافية
                    task.wait(0.05)
                end
