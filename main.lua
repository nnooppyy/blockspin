...
----------------------------------------------------
-- منطق الـ Auto Respawn (يضغط كل 3 ثوانٍ فقط لو الكلمة موجودة، ويتوقف لو اختفت)
----------------------------------------------------
...
task.spawn(function()
    ...
    while true do
        task.wait(0.5) -- فحص الشاشة كل نصف ثانية
        if autoRespawnEnabled then
            ...
            -- طالما الكلمة موجودة، يضغط كل 3 ثوانٍ. وإذا اختفت يخرج من الحلقة ويتوقف
            while respawnFound and autoRespawnEnabled do
                local centerX = 400
                local centerY = 220
                ...
                -- الانتظار 3 ثوانٍ قبل الضغطة التالية
                task.wait(3)
                
                -- إعادة التحقق بعد الانتظار لمعرفة هل ما زالت الكلمة موجودة أم اختفت
                respawnFound = false
