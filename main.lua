                    ...
                    if not isDepositing then
                        ...
                        while autoFarm and playerHasBox() and not isDepositing do
                            ...
                            if realDeliveryPoint then
                                ...
                                -- حلقة التعبئة (تتأكد من البقاء داخل الدائرة والامساك بالصندوق فوراً)
                                while autoFarm and isTargetStillActive(realDeliveryPoint) and not isDepositing do
                                    ...
                                    -- 1. إذا خرج من نطاق الدائرة بسبب التبقيس، يعيده لمركزها فورا
                                    if distFromCenter > 3.5 then
                                        hrp.CFrame = CFrame.new(currentPos)
                                        task.wait(0.05)
                                        
                                        -- فحص فوري للصندوق عند الإرجاع
                                        if not isUsingBoxActive() then
                                            pressTwoKey()
                                            task.wait(0.05)
                                        end
                                    ...
                                    -- 2. التأكد المستمر أثناء التعبئة أن الصندوق ممسوك باليد، وإذا سقط يضغط 2 فوراً
                                    if not isUsingBoxActive() then
                                        pressTwoKey()
                                        task.wait(0.05)
                                    end
