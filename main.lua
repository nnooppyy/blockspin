...
-- =========================================================================
-- مسار الإيداع المطلوب (يتم إيداع كامل الأموال الحالية)
-- =========================================================================
        ...
        task.spawn(function()
            while autoFarm do
                if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
                    ...
                    -- فحص المبلغ: إذا وصل للحد أو تخطاه، يتم إيداع كل الفلوس مرة واحدة
                    local currentCash = getPlayerCash()
