...
-- دالة لتحديد أقرب نقطة من نقاط المسار (من 1 إلى 6) عندما يكون اللاعب داخل البقالة، ثم المشي بالترتيب حتى النقطة 6
            ...
            if not playerHasBox() then
                if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
                    ...
                    if isInsideGrocery(hrp.Position) then
                        -- إذا كان اللاعب داخل البقالة، يذهب لأقرب نقطة مسار (من 1 إلى 6) ثم يمشي بالتتابع حتى النقطة 6
